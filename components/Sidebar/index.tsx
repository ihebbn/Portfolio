      ...
      >
        <MotionStack variants={stagger} spacing={6} w="100">
          ...
          <MotionText
            ...
            variants={fadeInUp}
          >
            Or you could call me Iheb. That works too . . .
          </MotionText>
          ...
          >
            ...
            end integration, recently found myself exploring the fascinating world of AI and DevOps.
          </MotionText>
          <MotionButton
            size="lg"
            variant="outline"
            ...
            as={'a'}
            href="mailto:benslama.mohamediheb@gmail.com"
            target="_blank"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          >
